...
DRAM.py annotate -i /home/projects-wrighton/Trivedi_soil_fire/reads/completed_assemblies/gene_resolved_metaG_analyses/2500_size_filtered/all_assembled_scaffolds_2500.fasta -o /home/projects-wrighton/Trivedi_soil_fire/reads/completed_assemblies/gene_resolved_metaG_analyses/2500_size_filtered/DRAM_unclustered_genes --min_contig_size 2500 --threads 20 --use_camper --use_fegenie --use_sulfur --use_vogdb &> log_trivedi_dram_unclustered_genes.txt