...
mv "$element".97ID.sorted.bam /home/projects-wrighton/Trivedi_soil_fire/reads/completed_assemblies/gene_resolved_metaG_analyses/2500_size_filtered/read_mapping_genes_output 

echo "Finished mapping and samtools for '$element' in list" 
#clean up the files
#rm -r "$element".sam
#rm -r "$element".bam
#rm -r "$element"_mapped_97ID.FILTERED.bam
